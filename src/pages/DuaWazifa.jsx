          ...
          <div className="bg-white rounded-3xl p-10 lg:p-14 border border-emerald-900/10 shadow-2xl space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl bg-[#FAF9F5] border border-emerald-900/10 space-y-2">
                <h3 className="font-serif text-xl font-bold text-[#022C22]">During Separation & Heartbreak</h3>
              ...
              <div className="p-6 rounded-2xl bg-[#FAF9F5] border border-emerald-900/10 space-y-2">
                <h3 className="font-serif text-xl font-bold text-[#022C22]">Family Conflicts & Friction</h3>
                <p className="text-xs text-emerald-950/80 font-light leading-relaxed">
              ...
              <div className="p-6 rounded-2xl bg-[#FAF9F5] border border-emerald-900/10 space-y-2">
                <h3 className="font-serif text-xl font-bold text-[#022C22]">Personal Stress & Trials</h3>
                <p className="text-xs text-emerald-950/80 font-light leading-relaxed">
